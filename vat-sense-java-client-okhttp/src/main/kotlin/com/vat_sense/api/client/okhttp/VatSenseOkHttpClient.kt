...
import com.vat_sense.api.client.VatSenseClientImpl
...
/**
 * A class that allows building an instance of [VatSenseClient] with [OkHttpClient] as the
 * underlying [HttpClient].
 */
class VatSenseOkHttpClient private constructor() {

    companion object {

        /** Returns a mutable builder for constructing an instance of [VatSenseClient]. */
         ...
         */
        @JvmStatic fun fromEnv(): VatSenseClient = builder().fromEnv().build()
    }

    /** A builder for [VatSenseOkHttpClient]. */
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [VatSenseClient].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): VatSenseClient =
            VatSenseClientImpl(
                clientOptions
                    .httpClient(
