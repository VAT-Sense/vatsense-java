...
package com.vat_sense.api.client.okhttp

import com.fasterxml.jackson.databind.json.JsonMapper
import com.vat_sense.api.client.VatSenseClientAsync
import com.vat_sense.api.client.VatSenseClientAsyncImpl
import com.vat_sense.api.core.ClientOptions
import com.vat_sense.api.core.Sleeper
import com.vat_sense.api.core.Timeout
...
/**
 * A class that allows building an instance of [VatSenseClientAsync] with [OkHttpClient] as the
 * underlying [HttpClient].
 */
class VatSenseOkHttpClientAsync private constructor() {

    companion object {

        /** Returns a mutable builder for constructing an instance of [VatSenseClientAsync]. */
         ...
         */
        @JvmStatic fun fromEnv(): VatSenseClientAsync = builder().fromEnv().build()
    }

    /** A builder for [VatSenseOkHttpClientAsync]. */
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [VatSenseClientAsync].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): VatSenseClientAsync =
            VatSenseClientAsyncImpl(
                clientOptions
                    .httpClient(
