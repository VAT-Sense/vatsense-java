...
dependencies {
    testImplementation(project(":vat-sense-java"))
...
val proguardJar by tasks.registering(proguard.gradle.ProGuardTask::class) {
    ...
    configuration("../vat-sense-java-core/src/main/resources/META-INF/proguard/vat-sense-java-core.pro")
}
...
val testProGuard by tasks.registering(JavaExec::class) {
    ...
    mainClass.set("com.vat_sense.api.proguard.ProGuardCompatibilityTest")
...
val r8Jar by tasks.registering(JavaExec::class) {
    ...
    args = listOf(
        ...
        "--pg-conf", "./test.pro",
        "--pg-conf", "../vat-sense-java-core/src/main/resources/META-INF/proguard/vat-sense-java-core.pro",
