...
private constructor(
    ...
    private val data: JsonField<List<Country>>,
    ...
    private constructor(
        ...
        @JsonProperty("data") @ExcludeMissing data: JsonField<List<Country>> = JsonMissing.of(),
     ...
     *   server responded with an unexpected value).
     */
    fun data(): Optional<List<Country>> = data.getOptional("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<List<Country>> = data
    ...
    class Builder internal constructor() {
        ...
        private var data: JsonField<MutableList<Country>>? = null
        private var success: JsonField<Boolean> = JsonMissing.of()
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(countryListResponse: CountryListResponse) = apply {
            code = countryListResponse.code
            data = countryListResponse.data.map { it.toMutableList() }
            success = countryListResponse.success
        ...
        fun data(data: List<Country>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed `List<Country>` value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun data(data: JsonField<List<Country>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [Country] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: Country) = apply {
            this.data =
    ...
    override fun toString() =
        "CountryListResponse{code=$code, data=$data, success=$success, additionalProperties=$additionalProperties}"
}
