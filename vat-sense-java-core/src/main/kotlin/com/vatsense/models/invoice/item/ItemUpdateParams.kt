...
private constructor(
    ...
    private val invoiceItemInput: InvoiceItemInput,
    ...
    fun invoiceItemInput(): InvoiceItemInput = invoiceItemInput

    fun _additionalBodyProperties(): Map<String, JsonValue> =
        invoiceItemInput._additionalProperties()
    ...
    class Builder internal constructor() {
        ...
        private var invoiceItemInput: InvoiceItemInput? = null
        private var additionalHeaders: Headers.Builder = Headers.builder()
        private var additionalQueryParams: QueryParams.Builder = QueryParams.builder()

        @JvmSynthetic
        internal fun from(itemUpdateParams: ItemUpdateParams) = apply {
            invoiceId = itemUpdateParams.invoiceId
            itemId = itemUpdateParams.itemId
            invoiceItemInput = itemUpdateParams.invoiceItemInput
        ...
        fun invoiceItemInput(invoiceItemInput: InvoiceItemInput) = apply {
        ...
        fun build(): ItemUpdateParams =
            ItemUpdateParams(
                ...
                itemId,
                checkRequired("invoiceItemInput", invoiceItemInput),
                additionalHeaders.build(),
                additionalQueryParams.build(),
            )
    }

    fun _body(): InvoiceItemInput = invoiceItemInput
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ItemUpdateParams &&
            ...
            itemId == other.itemId &&
            invoiceItemInput == other.invoiceItemInput &&
            additionalHeaders == other.additionalHeaders &&
            additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int =
        Objects.hash(invoiceId, itemId, invoiceItemInput, additionalHeaders, additionalQueryParams)

    override fun toString() =
        "ItemUpdateParams{invoiceId=$invoiceId, itemId=$itemId, invoiceItemInput=$invoiceItemInput, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
