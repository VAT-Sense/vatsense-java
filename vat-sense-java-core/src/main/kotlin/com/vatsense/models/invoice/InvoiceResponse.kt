...
private constructor(
     ...
     *   server responded with an unexpected value).
     */
    fun data(): Optional<Invoice> = data.getOptional("data")
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [InvoiceResponse]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [InvoiceResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(invoiceResponse: InvoiceResponse) = apply {
            code = invoiceResponse.code
            data = invoiceResponse.data
            success = invoiceResponse.success
            additionalProperties = invoiceResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [InvoiceResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): InvoiceResponse =
            InvoiceResponse(code, data, success, additionalProperties.toMutableMap())
    }
    ...
    override fun toString() =
        "InvoiceResponse{code=$code, data=$data, success=$success, additionalProperties=$additionalProperties}"
}
