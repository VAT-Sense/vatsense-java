...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(itemRetrieveParams: ItemRetrieveParams) = apply {
            invoiceId = itemRetrieveParams.invoiceId
    ...
    override fun hashCode(): Int =
        Objects.hash(invoiceId, itemId, additionalHeaders, additionalQueryParams)

    override fun toString() =
        "ItemRetrieveParams{invoiceId=$invoiceId, itemId=$itemId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
