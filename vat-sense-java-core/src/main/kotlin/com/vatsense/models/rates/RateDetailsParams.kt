...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): RateDetailsParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [RateDetailsParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [RateDetailsParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(rateDetailsParams: RateDetailsParams) = apply {
            countryCode = rateDetailsParams.countryCode
            eu = rateDetailsParams.eu
            ipAddress = rateDetailsParams.ipAddress
            period = rateDetailsParams.period
            provinceCode = rateDetailsParams.provinceCode
            type = rateDetailsParams.type
            additionalHeaders = rateDetailsParams.additionalHeaders.toBuilder()
            additionalQueryParams = rateDetailsParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [RateDetailsParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): RateDetailsParams =
            RateDetailsParams(
                countryCode,
                eu,
                ipAddress,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is RateDetailsParams &&
    ...
    override fun toString() =
        "RateDetailsParams{countryCode=$countryCode, eu=$eu, ipAddress=$ipAddress, period=$period, provinceCode=$provinceCode, type=$type, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
