...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [RateListTypesResponse]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [RateListTypesResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(rateListTypesResponse: RateListTypesResponse) = apply {
            code = rateListTypesResponse.code
            data = rateListTypesResponse.data.map { it.toMutableList() }
            success = rateListTypesResponse.success
            additionalProperties = rateListTypesResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [RateListTypesResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): RateListTypesResponse =
     ...
     *   expected type.
     */
    fun validate(): RateListTypesResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is RateListTypesResponse &&
            code == other.code &&
            data == other.data &&
    ...
    override fun toString() =
        "RateListTypesResponse{code=$code, data=$data, success=$success, additionalProperties=$additionalProperties}"
}
