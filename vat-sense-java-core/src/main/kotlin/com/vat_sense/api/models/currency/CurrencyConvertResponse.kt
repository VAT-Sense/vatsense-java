...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [CurrencyConvertResponse]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [CurrencyConvertResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(currencyConvertResponse: CurrencyConvertResponse) = apply {
            code = currencyConvertResponse.code
            data = currencyConvertResponse.data
            success = currencyConvertResponse.success
            additionalProperties = currencyConvertResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [CurrencyConvertResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): CurrencyConvertResponse =
            CurrencyConvertResponse(code, data, success, additionalProperties.toMutableMap())
    }

    private var validated: Boolean = false

    fun validate(): CurrencyConvertResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
        ...
        private val converted: JsonField<Double>,
        ...
        private constructor(
            ...
            @ExcludeMissing
            converted: JsonField<Double> = JsonMissing.of(),
        ...
        ) : this(amount, converted, from, object_, rate, to, mutableMapOf())
         ...
         *   the server responded with an unexpected value).
         */
        fun converted(): Optional<Double> = converted.getOptional("converted")
         ...
         *
         * Unlike [converted], this method doesn't throw if the JSON field has an unexpected type.
         */
        @JsonProperty("converted") @ExcludeMissing fun _converted(): JsonField<Double> = converted
        ...
        class Builder internal constructor() {
            ...
            private var converted: JsonField<Double> = JsonMissing.of()
            ...
            /** The converted amount. */
            fun converted(converted: Double) = converted(JsonField.of(converted))

            /**
             * Sets [Builder.converted] to an arbitrary JSON value.
             *
             * You should usually call [Builder.converted] with a well-typed [Double] value instead.
             * This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun converted(converted: JsonField<Double>) = apply { this.converted = converted }
        ...
        private val hashCode: Int by lazy {
            Objects.hash(amount, converted, from, object_, rate, to, additionalProperties)
        }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Data{amount=$amount, converted=$converted, from=$from, object_=$object_, rate=$rate, to=$to, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CurrencyConvertResponse &&
            code == other.code &&
            data == other.data &&
    ...
    override fun toString() =
        "CurrencyConvertResponse{code=$code, data=$data, success=$success, additionalProperties=$additionalProperties}"
}
