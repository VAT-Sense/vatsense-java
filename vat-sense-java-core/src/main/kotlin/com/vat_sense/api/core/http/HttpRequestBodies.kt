...
import com.vat_sense.api.core.MultipartField
...
private fun serializePart(name: String, node: JsonNode): Sequence<Pair<String, InputStream>> =
    when (node.nodeType) {
                    ...
                    node
                        ...
                        .mapNotNull { element ->
                            when (element.nodeType) {
                                ...
                                JsonNodeType.OBJECT,
                                JsonNodeType.POJO ->
                                    throw VatSenseInvalidDataException(
        ...
        JsonNodeType.POJO,
        null -> throw VatSenseInvalidDataException("Unexpected JsonNode type: ${node.nodeType}")
    }
